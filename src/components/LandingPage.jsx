...
const LandingPage = () => {
  return (
    <div className="h-[calc(100vh-80px)] flex flex-col justify-between">
      ...
      {/*Section 2*/}
      <div className="w-[100vw] left-[-6%] h-screen relative flex justify-center items-end">
        <div className="absolute p-0 bg-[#eff5e1] inset-0 z-0 flex flex-col justify-end items-center px-4 gap-20">
          <div className="w-full flex justify-start">
            <button className="bg-[#2D3B36] text-white px-6 py-2 rounded-[100px] mt-4 w-[180px] h-[60px] cursor-pointer ml-[10%]">
              Shop Now
            </button>
          </div>
